    ...
    <main id="main" class="site-main">
        ...
        <section class="events-hero-section position-relative d-flex align-items-center justify-content-center text-center text-light">
            ...
            <div class="container position-relative z-index-1">
                ...
                <h2 class="fw-bold text-golden mb-4" style="text-transform: uppercase">
                    Upcoming Events
                </h2>
            </div>
        ...
        <div class="container py-5 text-light animate__animated animate__fadeInUp">
            ...
            $events_query = new WP_Query([
                ...
                'paged'          => $paged,
                'post_status'    => 'publish',
                'meta_key'       => 'main_data_date_hour_event', // Campo de fecha para ordenar
                'orderby'        => 'meta_value',                // Ordenar por el valor del campo
                'order'          => 'DESC',
            ]);
